...
wire [63:0] rs1,rs2,imm_out,in2,res,out,write_data,inc, incremented_mem_addr, branched_mem_addr; 
...
// writing Back
assign write_data = (MemToReg[0] == 0) ? res : temp2;
assign write_data = (MemToReg[1] == 0) ? write_data : out;
