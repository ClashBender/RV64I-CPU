...
the address is provided, without waiting for a clock edge. This was 
necessary to ensure that each instruction executes in a single cycle, as 
required by the project document. The module also includes control signals to enable or disable memory read and write operations, ensuring proper synchronization with the CPU's instruction execution cycle.
\begin{figure}[!ht]
  \centering
