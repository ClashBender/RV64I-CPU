...
`include "src/stages/1_fetch/fetch.v"
`include "src/stages/2_decode/decode.v"
`include "src/stages/3_execute/execute.v"
`include "src/stages/4_memory/memory.v"
`include "src/stages/5_writeback/writeback.v"
`include "src/hazards/hazards.v"
