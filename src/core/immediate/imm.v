...
module imm(
    ...
    always @(*) begin 
        case (instruction[6:0])
            ...
            7'b1100011: imm_out = {{52{instruction[31]}}, instruction[7], instruction[30:25], instruction[11:8], 1'b0}; // B-type
            7'b1101111: imm_out = {{44{instruction[31]}}, instruction[19:12], instruction[20], instruction[30:21], 1'b0}; // J-type
